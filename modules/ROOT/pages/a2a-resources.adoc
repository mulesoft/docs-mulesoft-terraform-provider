...
* `configuration` - (Block) Agent card content and serving configuration. See <<Nested Schema for configuration>>.
...
* `pointcut_data` - Scope the policy to specific HTTP methods and URI patterns as a JSON string. When `null`, the policy applies to all resources. Use `jsonencode()` to set this. See <<Pointcut Data>>.
...
* `configuration` - (Block) PII detection configuration. See <<Nested Schema for configuration>>.
...
* `configuration` - (Block) Decorator configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Rate limit configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Transformation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Circuit breaker thresholds. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy monitors.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Client credential extraction configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) CORS configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Credential injection configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) OAuth 2.0 token injection configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) On-Behalf-Of token exchange configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Filter script configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Header transformation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Token validation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Header injection configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Header removal configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Health check configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Authentication credentials. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Cache configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Timeout configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy monitors.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Authentication configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Authorization code flow configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy applies to.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Allowlist configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Blocklist configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Injection protection configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) JSON structural limits. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) JWT validation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) LDAP connection and search configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) AWS Bedrock connection configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy applies to.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Gemini connection configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy applies to.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Vendor routing configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Access control configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Schema validation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Tool mapping configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Transcoding router configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Logging configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Routing configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Telemetry configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Lambda invocation configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy applies to.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) External authorization configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) External processor configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Token introspection configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) OpenAI connection configuration. See <<Nested Schema for configuration>>.
* `upstream_ids` - (Required, List of String) Upstream IDs this policy applies to.
* `pointcut_data` - Pointcut definition as a JSON string. See <<Pointcut Data>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Prompt guard configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Semantic routing configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) SLA-based rate limit configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Script configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) SSE logging configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Spec validation configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Spike control configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) Tracing configuration. See <<Nested Schema for configuration>>.
...
* `environment_id` - ID of the environment where the API instance lives.
* `api_instance_id` - ID of the API instance this policy is applied to.
* `configuration` - (Block) XML structural limits. See <<Nested Schema for configuration>>.
