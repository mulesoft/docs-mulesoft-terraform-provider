...
* `aws_transit_gateway_id` - The AWS TGW ID discovered by the platform from the resource share. Populated after creation.
...
* `aws_transit_gateway_id` - The AWS TGW ID.
