...
NOTE: Replace `0.0.8` with the latest version. See the https://registry.terraform.io/providers/mulesoft/anypoint/latest[MuleSoft Anypoint provider on the Terraform Registry] for the current release.
